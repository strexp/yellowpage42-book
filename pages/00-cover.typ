...
#align(center + horizon)[
  #box(width: 100%, height: 96%, stroke: 4pt + black, inset: 4pt)[
    #box(width: 100%, height: 100%, stroke: 1pt + black, inset: 15pt)[
      ...
      #align(left)[
        #text(size: 12pt, weight: "bold", tracking: 1pt, upper("For dn42 Telephony Network Users"))\
        #text(
          size: 12pt,
      ...
      #v(3em)
      #text(size: 34pt, weight: "black", tracking: 3pt, font: book_font_display, upper(book_title)) \ \ \
      #text(size: 20pt, weight: "bold", tracking: 1pt, font: book_font_display, upper(book_subtitle))

      #v(1fr)

      #text(size: 14pt, weight: "bold", font: book_base_font_sans, book_author) \
      #text(size: 12pt, style: "italic", font: book_base_font_sans, book_author_dep)
